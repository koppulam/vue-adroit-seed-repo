...
*/
export function PopupMenuLinks(domNode, controllerObj) {
    var elementChildren,
  ...
  */
  PopupMenuLinks.prototype.init = function (wrapperClass) {
    ...
    while (childElement) {
      menuElement = childElement.querySelector('a');
  ...
  PopupMenuLinks.prototype.open = function () {
    ...
    if (this.wrapperClass) {
        $(this.wrapperClass).slideToggle('fast', 'linear');
    }
