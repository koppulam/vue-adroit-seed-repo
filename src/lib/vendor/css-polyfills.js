...
if (((browserInfo.os.name === 'Windows' || browserInfo.os.name === 'Macintosh') && browserInfo.browser.name === 'Chrome' && browserInfo.browser.version < 57)
	|| ((browserInfo.os.name === 'Macintosh') && browserInfo.browser.name === 'Safari' && browserInfo.browser.version < 10.1)) {
	!(function () {
		'use strict';
		var module = {
			exports: {}
				...
				parseTrackBreadthToken: function (cssToken) {
					...
					if (cssToken instanceof cssSyntax.IdentifierToken) {
						...
						if (cssToken.value == "auto") {
							return {
								type: TRACK_BREADTH_AUTO,
								value: "auto"
							};
						} else if (cssToken.value == "min-content") {
							return {
								type: TRACK_BREADTH_MIN_CONTENT,
								value: "min-content"
							};
						} else if (cssToken.value == "max-content") {
							return {
								type: TRACK_BREADTH_MAX_CONTENT,
								value: "max-content"
							};
						}
						...
						if (cssToken.unit == "fr") {
							return {
								type: TRACK_BREADTH_FRACTION,
								value: cssToken.value
							};
						} else {
							return {
